...
import "../styles.css"; 
import { AcademicCalender,Objectives,SyllabusBooks,TimeTable } from "./Academics";
            ...
            <div className="row ecaDiv p-5">
              <div className="col-lg-2 eventsDiv mt-2">
                ...
                <div className="announceMarquee">
                  <ul>
                    <li><a href="#">MIWAI - 2023</a></li>
                    <li><a href="#">MIWAI to start on 20th July, 2023</a></li>
                    <li><a href="#">MIWAI to start on 20th July, 2023</a></li>
                    <li><a href="#">MIWAI to start on 20th July, 2023</a></li>
                    <li><a href="#">MIWAI to start on 20th July, 2023</a></li>
                    <li><a href="#">MIWAI to start on 20th July, 2023</a></li>
                ...
                <div className="container">
                  <div className="row">
                    <div className="col-lg-12">
                      <div id="carouselA" className="carousel slide carouselBoth" data-bs-ride="carousel">
                        <div className="carousel-indicators">
                          <li data-bs-target="#carouselA" data-bs-slide-to="0" className="active"></li>
                          <li data-bs-target="#carouselA" data-bs-slide-to="1"></li>
                          <li data-bs-target="#carouselA" data-bs-slide-to="2"></li>
                          <li data-bs-target="#carouselA" data-bs-slide-to="3"></li>
                        </div>
              ...
              <div className="col-lg-2 announceDiv mt-2">
                <p>Announce@CSE</p>
                <div className="announceMarquee">
                  <marquee direction="up" scrollamount="5" onMouseEnter={(e) => e.target.stop()} onMouseLeave={(e) => e.target.start()}>
                    <ul>
                      <li><a href="#">MIWAI to start on 20th July, 2023</a></li>
                      <li><a href="#">MIWAI to start on 20th July, 2023</a></li>
                      <li><a href="#">MIWAI to start on 20th July, 2023</a></li>
          ...
          <div className="container mt-5">
            <div className="row">
              <div className="col-md-12 p-5">
                <h2 className="text-center text-uppercase">Message by Head of the Department</h2>
              </div>
            </div>
            ...
            <div className="row">
              ...
              <div className="col-md-6">
                <div className="msghoddiv" data-aos="fade-left" data-aos-duration="1000">
                  ...
                  <p className="msghodp">
                    The department of Computer Science and Engineering has been flourishing by leaps and bounds since its inception in 2001 and has seen unprecedented growth. It currently offers four undergraduate programs and a postgraduate program. The department is a JNTUH recognized Research Centre.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="container mt-5">
            <div className="row">
              <div className="col-sm-12">
                <h2 className="text-center text-uppercase">Deptartment Virtuoso</h2>
              </div>
            </div>
            <div className="container">
              <div className="facultyCardContainer">
                <div className="facultyCard" data-aos="fade-up" data-aos-duration="1500">
                  ...
                  <div className="facultyCardInfo">
                    ...
                    <p className="facultyCardDept">Department of Computer Science and Engineering</p>
                  </div>
                </div>
                <div className="facultyCard" data-aos="fade-up" data-aos-duration="1500">

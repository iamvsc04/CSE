        ...
        <section className="objectivesSection">
          <div className="row mt-4">
            <div className="col-sm-12">
              <h2 className="text-center" style={{ letterSpacing: "1px", textTransform: "uppercase" }}>
                    ...
                    <div className="flip-card__container">
                      <div className="card-front">
                        ...
                        <div className="card-front__bt">
                          <p className="card-front__text-view2 card-front__text-view--city2">View me</p>
                        </div>
                      </div>
                      <div className="card-back" style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                        <h3 className="inside-page__heading2 inside-page__heading--city2">{pso.title}</h3>
                      </div>
                    </div>
                  </div>
                  <div className="inside-page">
                    <div className="inside-page__container">
                      <p className="text-justify inside-page__text2">{pso.description}</p>
                    </div>
                  </div>
                </div>
              ))}
                ...
                <div className="card" key={peo.id} style={{ marginTop: "5px" }}>
                  <div className="flip-card">
                    <div className="flip-card__container">
                      ...
                      <div className="card-back" style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                        <h3 className="inside-page__heading--city">{peo.title}</h3>
                      </div>
                    </div>
                  </div>
                  <div className="inside-page">
                    <div className="inside-page__container">
                      <p className="text-justify inside-page__text">{peo.description}</p>
                    </div>
                  </div>
                </div>
              ))}
                  ...
                  <div className="flip-card">
                    <div className="flip-card__container">
                      <div className="card-front">
                        ...
                        <div className="card-front__bt">
                          <p className="card-front__text-view1 card-front__text-view--city1">View me</p>
                        </div>
                      </div>
                      <div className="card-back" style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                        <h3 className="inside-page__heading1 inside-page__heading--city1">{po.title}</h3>
                      </div>
                    </div>
                  </div>
                  <div className="inside-page">
                    <div className="inside-page__container">
                      <p className="text-justify inside-page__text1">{po.description}</p>
                    </div>
                  </div>
                </div>
              ))}

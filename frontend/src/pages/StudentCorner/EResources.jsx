  ...
  const programOutcomes = [
    {
      ...
      subjects: [
        { name: "Problem Solving Through C", links: ["SWAYAM", "DIGITAL LIBRARY OF INDIA"] },
      ],
    },
    {
      year: "First Year II-Semester",
      subjects: [
        { name: "Data Structures Through C", links: ["Notes"] },
      ],
    },
    {
      year: "Second Year I-Semester",
      subjects: [
        { name: "Object Oriented Programming Through Java", links: ["JavaPoint Tutorials", "TutorialsPoint"] },
        { name: "Discrete Structures and Graph Theory", links: ["TutorialsPoint1", "NPTEL"] },
        { name: "Boolean Algebra and Circuit Design", links: ["NESO ACADEMY Video Lectures"] },
        { name: "Probability and Statistics", links: ["Video Tutorials"] },
        { name: "Unix and Shell Programming", links: ["Notes", "TutorialsPoint", "NPTEL", "Unix and Shell"] },
    ...
    },
    {
      ...
      subjects: [
        { name: "Principles of Programming Languages", links: ["NOTES", "NPTEL"] },
        { name: "Data Structures Through Java", links: ["DSJ", "BeginnersBook", "Tutorials Point"] },
        { name: "DataBase Management Systems", links: ["NOTES", "NPTEL", "TutorialsPoint", "Online Notes"] },
        { name: "Environmental Studies", links: [] },
        { name: "Design And Analysis of Algorithms", links: ["NOTES", "NPTEL", "Youtube Lectures(Abul Bari)", "TutorialsPoint"] },
        { name: "Computer Organization", links: ["NPTEL", "NESO ACADEMY Video Lectures"] },
      ],
    },
    {
      year: "Third Year I-Semester",
      subjects: [
        { name: "Web Technologies", links: ["JavaPoint Tutorials", "GeeksForGeeks", "W3Schools"] },
        { name: "Managerial Economics And Financial Analysis", links: ["Youtube Lectures"] },
        { name: "Operating Systems", links: ["NPTEL", "NPTEL 2"] },
        { name: "Data Communication and Computer Networks", links: ["NPTEL 1", "NPTEL Videos"] },
      ],
    },
    {
      ...
      subjects: [
        ...
        { name: "Object Oriented Analysis And Design", links: ["NOTES", "Text Book"] },
        { name: "Introduction To Analytics", links: ["NOTES", "NPTEL"] },
        { name: "Web Engineering", links: ["CSS 3", "HTML 5", "Node JS", "Express JS", "Type Script", "Angular 2"] },
        { name: "MVC Through Scripting Languages", links: ["Quick Guide", "Tutorials Point"] },
    ...
    },
    {
      ...
      subjects: [
        { name: "Automata & Complier Design", links: ["Tutorials Point", "NPTEL"] },
        { name: "Linux Programming", links: ["NPTEL", "javatpoint"] },
        { name: "Data Warehousing and Data Mining", links: ["NOTES", "Weka Manual", "Slides"] },
        { name: "Big Data Analytics", links: ["NPTEL"] },
        { name: "Soft Computing", links: ["NOTES", "NPTEL"] },
        { name: "Design Patterns", links: ["NPTEL"] },
        { name: "Web services and Cloud Computing", links: ["NPTEL", "NPTEL 2"] },
        { name: "Internet Of Things", links: ["NOTES", "NPTEL", "NPTEL 2"] },
        { name: "Software Testing Methodologies", links: ["NOTES", "Text Book"] },
    ...
    },
    {
      ...
      subjects: [
        ...
        { name: "Image Processing and Pattern Recognition", links: ["Videos", "NPTEL"] },
          ...
          <div className="container mt-5">
            ...
            {programOutcomes.map((yearData, yearIndex) => (
              <section key={yearIndex} className="card-area">
                ...
                <section className="card-section" data-aos="fade-up" data-aos-duration="1000">
